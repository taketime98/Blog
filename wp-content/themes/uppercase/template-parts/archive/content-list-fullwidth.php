<?php
/**
 * Template part for displaying list fullwidth posts
 *
 * @package Uppercase
 */

$ratio_class = 'cs-overlay-ratio cs-ratio-' . $options['tile_image_orientation'];
...
<article <?php post_class(); ?>>
	...
	<div class="cs-entry__outer">
		...
		<?php if ( has_post_thumbnail() ) { ?>
			<div class="cs-entry__inner cs-entry__overlay cs-entry__thumbnail <?php echo esc_attr( $ratio_class ); ?>">
