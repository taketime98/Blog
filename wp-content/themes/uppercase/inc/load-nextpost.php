...
function csco_nextpost_get_id() {
	...
	if ( $cs_archive_singular ) {
		...
		$object = get_previous_post( false );
...
function csco_nextpost_more_js() {
	...
	$args = array(
		'type'             => $ajax_type,
		'archive_singular' => $cs_archive_singular,
...
function csco_load_nextpost() {
	...
	if ( isset( $_POST['archive_singular'] ) ) { // Input var ok.
		$cs_archive_singular = (bool) $_POST['archive_singular'];  // Input var ok.
	}
	...
	if ( isset( $post_id ) ) {
		...
		if ( $cs_archive_singular ) {
			set_query_var( 'cs_archive_singular', true );
		}
								...
								<div class="<?php echo esc_attr( $overlay_class ); ?>">
									...
									<div class="cs-page-header-item">
										...
										<div class="cs-page-header-inner">
											...
											<?php get_template_part( 'template-parts/header/header', 'inner-nextpost' ); ?>
								...
								<div class="cs-content-inner">
									...
									<div class="cs-content-item">
										...
										<?php do_action( 'csco_main_before' ); ?>
											...
											<?php do_action( 'csco_' . get_post_type() . '_before' ); ?>

												<?php get_template_part( 'template-parts/content-singular' ); ?>

											<?php do_action( 'csco_' . get_post_type() . '_after' ); ?>
