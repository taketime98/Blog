...
if ( ! function_exists( 'csco_content_width' ) ) {
	...
	function csco_content_width() {
		$GLOBALS['content_width'] = apply_filters( 'csco_content_width', 640 );
	}
}
...
if ( ! function_exists( 'csco_enqueue_scripts' ) ) {
	...
	function csco_enqueue_scripts() {
		...
		wp_register_script( 'flickity', get_template_directory_uri() . '/assets/vendor/flickity.pkgd.min.js', array( 'jquery' ), '2.2.1', true );
