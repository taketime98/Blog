 ...
 */
function csco_canvas_register_layout_list( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'List', 'uppercase' ),
		'template'    => get_template_directory() . '/template-parts/blocks/posts-area.php',
		'icon'        => '<svg width="52" height="44" xmlns="http://www.w3.org/2000/svg"><g transform="translate(1 1)" stroke="#2d2d2d" fill="none" fill-rule="evenodd"><rect stroke-width="1.5" width="50" height="42" rx="3"></rect><g transform="translate(5 23)"><rect stroke-width="1.5" width="18" height="14" rx="1"></rect><path d="M22.5 3.5h14m-14 3h17m-17 3h12" stroke-linecap="round" stroke-linejoin="round"></path></g><g transform="translate(5 5)"><rect stroke-width="1.5" width="18" height="14" rx="1"></rect><path d="M22.5 3.5h14m-14 3h17m-17 3h12" stroke-linecap="round" stroke-linejoin="round"></path></g></g></svg>',
		'sections'    => array(
			'general'    => array(
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_list' );
