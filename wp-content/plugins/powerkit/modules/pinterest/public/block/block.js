...
/* harmony import */ var _edit_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PinterestBoardBlockEdit; });
...
var PinterestBoardBlockEdit = /*#__PURE__*/function (_Component) {
  _inherits(PinterestBoardBlockEdit, _Component);

  var _super = _createSuper(PinterestBoardBlockEdit);

  function PinterestBoardBlockEdit() {
    var _this;

    _classCallCheck(this, PinterestBoardBlockEdit);

    _this = _super.apply(this, arguments);
    _this.state = {
      pinApi: false
    };
    _this.maybeFindGlobalPinObj = _this.maybeFindGlobalPinObj.bind(_assertThisInitialized(_this));
  ...
  _createClass(PinterestBoardBlockEdit, [{
    ...
    key: "maybeFindGlobalPinObj",
    value: function maybeFindGlobalPinObj() {
      var _this2 = this;
    ...
    value: function render() {
      ...
      className = classnames__WEBPACK_IMPORTED_MODULE_0___default()('pinterest-board-wrapper pk-block-pinterest-board', canvasClassName, className);
      return wp.element.createElement(Fragment, null, href ? wp.element.createElement(Disabled, null, wp.element.createElement("div", {
        className: className,
        key: "pin-board-".concat(href)
      }, wp.element.createElement("a", {
        "data-pin-do": "embedBoard",
        "data-pin-board-width": "100%",
        href: href
      }))) : wp.element.createElement(Placeholder, null, __('Please, enter Pinterest Board URL.')));
    }
  }]);

  return PinterestBoardBlockEdit;
}(Component);
