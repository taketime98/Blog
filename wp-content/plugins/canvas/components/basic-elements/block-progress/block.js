...
/* harmony import */ var _edit_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(160);
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ProgressBlockEdit; });
...
var ProgressBlockEdit = /*#__PURE__*/function (_Component) {
  _inherits(ProgressBlockEdit, _Component);

  var _super = _createSuper(ProgressBlockEdit);

  function ProgressBlockEdit() {
    _classCallCheck(this, ProgressBlockEdit);

    return _super.apply(this, arguments);
  }

  _createClass(ProgressBlockEdit, [{
    key: "render",
    value: function render() {
      ...
      var _this$props$attribute = this.props.attributes,
          ...
          striped = _this$props$attribute.striped,
          animated = _this$props$attribute.animated,
          displayPercent = _this$props$attribute.displayPercent,
          canvasClassName = _this$props$attribute.canvasClassName;
      className = classnames__WEBPACK_IMPORTED_MODULE_0___default()('cnvs-block-progress', {
        'cnvs-block-progress-striped': striped,
        'cnvs-block-progress-animated': striped && animated,
        'is-selected': isSelected
      }, canvasClassName, className);
      return wp.element.createElement(Fragment, null, wp.element.createElement(ResizableBox, {
        className: className,
        size: {
          height: height
        },
      ...
      }, displayPercent ? "".concat(width, "%") : '')));
    }
  }]);

  return ProgressBlockEdit;
}(Component);
