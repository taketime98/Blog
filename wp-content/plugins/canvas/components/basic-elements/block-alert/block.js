...
/* harmony import */ var _edit_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(143);
/* harmony import */ var _save_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(144);
/**
...
var AlertBlockEdit = /*#__PURE__*/function (_Component) {
  _inherits(AlertBlockEdit, _Component);

  var _super = _createSuper(AlertBlockEdit);

  function AlertBlockEdit() {
    var _this;

    _classCallCheck(this, AlertBlockEdit);
  ...
  _createClass(AlertBlockEdit, [{
    ...
    value: function render() {
      ...
      className = classnames__WEBPACK_IMPORTED_MODULE_0___default()('cnvs-block-alert', {
        'cnvs-block-alert-dismissible': dismissible
      }, canvasClassName, className);
      return wp.element.createElement(Fragment, null, wp.element.createElement("div", {
        className: className
      }, wp.element.createElement("div", {
        className: "cnvs-block-alert-inner"
      ...
      }) : __('Alert content')), dismissible ? wp.element.createElement("button", {
        className: "cnvs-close",
        type: "button",
        "data-dismiss": "alert",
        "aria-label": __('Close')
      }, wp.element.createElement("i", {
        className: "cnvs-icon-x"
      })) : ''));
    }
  }]);

  return AlertBlockEdit;
}(Component);

var AlertBlockEditWithSelect = withSelect(function (select, ownProps) {
...
/* harmony default export */ __webpack_exports__["default"] = (AlertBlockEditWithSelect);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AlertBlockSave; });
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var AlertBlockSave = /*#__PURE__*/function (_Component) {
  _inherits(AlertBlockSave, _Component);

  var _super = _createSuper(AlertBlockSave);

  function AlertBlockSave() {
    _classCallCheck(this, AlertBlockSave);

    return _super.apply(this, arguments);
  }

  _createClass(AlertBlockSave, [{
    key: "render",
    value: function render() {
