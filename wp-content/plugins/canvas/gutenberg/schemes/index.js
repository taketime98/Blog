...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(139);
...
var _window = window,
    $ = _window.jQuery,
    canvasLocalize = _window.canvasLocalize;
var __ = wp.i18n.__;
/**
...
$(document).on('DOMContentLoaded', function () {
  ...
  wp.data.subscribe(function () {
    ...
    $('.canvas-settings-toogle-scheme').attr('scheme', scheme); // Alt version.

    $('.block-editor-writing-flow').attr('site-data-scheme', scheme); // New version.
